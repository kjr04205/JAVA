 ...
 <div id="commentList">
        	...
        	<c:forEach var="comment" items="${commentList}">
                ...
                <div class="comment-area">
                    ...
                    <div class="comment-bottom">
                        ...
                        <a href="#" class="btn-write cmtA"  data-cno="1" data-bno="1070" data-pcno="">답글쓰기</a>
                        <a href="#" class="btn-modify cmtA" data-cno="1" data-bno="1070" data-pcno="">수정</a>
                        <a href="#" class="btn-delete cmtA" data-cno="1" data-bno="1070" data-pcno="">삭제</a>
                    </div>    
                </div>
            </li>
        	</c:forEach>
        ...
        <div id="comment-writebox">
            ...
            <div class="comment-writebox-content">
                <textarea class="cmtTextarea" name="" id="" cols="30" rows="3" placeholder="댓글을 남겨보세요"></textarea>
            </div>
        ...
        <div class="modal-content">
            ...
            <div id="modify-writebox">
                ...
                <div class="modify-writebox-content">
                    <textarea class="cmtTextarea" name="" id="" cols="30" rows="5" placeholder="댓글을 남겨보세요"></textarea>
                </div>
